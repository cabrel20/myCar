...
<body>
    <div class=" font-bold flex flex-col items-center">
       <div class="py-8">
        ...
        <h1 class="text-xl text-gray-600 text-center pt-4">Ajouter une annonce</h1>
       </div>
        <!-- Form -->
        <form action="" class="  px-20 flex flex-col items-center">
           <div class="grid grid-cols-2 gap-3">
            ...
            <button class=" mt-6 text-md text-white bg-violet-600 px-12 py-2 rounded-md">Ajouter</button>
        </form>
        <!--  -->
