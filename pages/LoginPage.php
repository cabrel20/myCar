...
<body>
    <div class=" font-bold flex flex-col items-center">
       <div class="py-8">
        ...
        <h1 class="text-xl text-gray-600 text-center pt-4">Login</h1>
       </div>
        <!-- Form -->
        <form action="" class="flex flex-col items-center gap-3">
            ...
            <button class="text-md text-white bg-violet-600 px-12 py-2 rounded-md">Login</button>
        </form>
        <!--  -->
        <div class="pt-12">
            <h1 class="text-gray-500">Vous n'avez pas de compte ? <a href="../pages/InscriptionPage.php" class=" underline text-violet-600">inscrivez vous</a></h1>
        </div>
    </div>
</body>
</html>